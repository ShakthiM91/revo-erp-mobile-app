  ...
  <div>
    <ion-item-sliding>
      ...
      <ion-item-options v-if="!category.is_default && category.tenant_id != null" side="end">
        ...
        <ion-item-option @click="$emit('edit')">Edit</ion-item-option>
        <ion-item-option v-if="!category.children?.length" color="danger" @click="$emit('delete')">Delete</ion-item-option>
        <ion-item-option v-if="!category.is_default && category.tenant_id != null" @click="$emit('toggle-active', category, !category.is_active)">
